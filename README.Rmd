...
fxnal_group<-gsub(unique_spp[1],uni_fxnal_group[1],gsub(unique_spp[2],uni_fxnal_group[2],
...
scaled_abun<-apply(len[,2:16], 2, scale)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4}
yt_fl<-subset(abun_df, spp=="Americanplaice")
...
th_sk<-subset(agg_spp, Group.2=="Americanplaice")
